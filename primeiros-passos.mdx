...
<AccordionGroup>
  <Accordion icon="github" title="Autenticando o servidor da API">
    ...
    begin
      ...
      edtApiGlobal.Text := 'ASD3F21APIDEVS6A5SPAULOJRDEVFA1'; // Chave Global API
      edtUrl.Text := 'https://apiv1demo.apidevs.app'; // URL do servidor
    end;
    ```
  </Accordion>

  <Accordion icon="rectangle-terminal" title="Instâncias 'Celulares de Clientes'">
