...
begin
  ...
  // Envia o botão usando o método EnviarBotao
  ApiEuAtendo.EnviarBotao('559982385000', 'Apidevs informa', 'Precisa de ajuda? Ligue para o nosso suporte.', 'Estamos sempre prontos para ajudar', Botao);
end;
```
...
begin
  ...
  // Envia o botão usando o método EnviarBotao
  ApiEuAtendo.EnviarBotao('559982385000', 'Apidevs informa', 'Aproveite nosso código promocional.', 'Copie o código abaixo e use em sua próxima compra', Botao);
end;
```
...
begin
  ...
  // Envia o botão usando o método EnviarBotao
  ApiEuAtendo.EnviarBotao('559982385000', 'Apidevs informa', 'Por favor, responda para continuar.', 'Estamos aguardando sua resposta', Botao);
end;
```
...
begin
  ...
  ApiEuAtendo.EnviarMultiplosBotoes('559982385000', 'Apidevs informa', 'Escolha uma das opções abaixo para continuar:', 'Estamos aqui para ajudar', [Botao1, Botao2, Botao3]);
end;
```
