...
<AccordionGroup>
  ...
  <Accordion icon="mobile" title="Conectar em uma instancia existente">
 ...
 <Accordion icon="mobile" title="Consultar Status da Instância">
 ...
 <Accordion icon="mobile" title="Listar Todas as Instâncias">
