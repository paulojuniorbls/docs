...
<Accordion icon="group" title="Trabalhando com Grupos">
    Ao trabalhar com grupos, você pode realizar diversas operações, como obter a lista de grupos, listar os contatos de um grupo específico, enviar mensagens para o grupo e enviar uma marcação fantasma.
