...
com vários contatos de uma só vez. A seguir, explicamos como aproveitar essas funções para obter, listar e interagir com grupos no seu sistema de atendimento.'
icon: 'people-group'
---
